...
def test():
    ...
    # Test with mixed language (adding English keywords)
    text1 = "Wind turbine tower joint 風力發電機塔架接合處"
    text2 = "Steering gear 轉向齒輪"
    text3 = "Wind turbine blade 風力發電機葉片"
    
    print("Testing with mixed Chinese/English text...")
    ...
    try:
        ...
        print(f"\nSimilarity (tower vs gear): {sim12:.4f}")
        print(f"Similarity (tower vs blade): {sim13:.4f}")
